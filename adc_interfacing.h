...
#include "atmega32a.h"
    ...
    #define    CHANGE_CAHNNEL_MASK 0xE0 //0b 1110 000
    #define CHANGE_ADC_CHANNEL_KEPP_OTHER_ADMUX_ADCSRA_SETTINGS(NEW_CHANNEL)     ADMUX = (ADMUX & CHANGE_CAHNNEL_MASK) | ((NEW_CHANNEL) & CHANNEL_SECUIRTY_MASK)
...
//    #define ADC_CLEAR ADCSRA = 0 ; ADMUX = 0; ADCL&0 ; ADCH&0;
    #define ADC_CLEAR ADCSRA = 0 ; ADMUX = 0;
